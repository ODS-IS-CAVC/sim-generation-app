...
from utils.image_util import read_image_unicode_path, write_image_unicode_path
...
class LoadBGRImages:  # for inference
    def __init__(self, path, img_size=640, stride=32):
        ...
        self.stride = stride
        self.images = images
        assert len(images) > 0, f'No images found in {p}. ' \
    ...
    def __next__(self):
        ...
        # Read image
        self.count += 1
        img0 = read_image_unicode_path(path)    # BGR
